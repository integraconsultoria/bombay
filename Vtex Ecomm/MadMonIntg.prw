...
oExecutados := MSNewGetDados():New(00,00,(oFldExecuc:ADIALOGS[1]:NHEIGHT/2),(oFldExecuc:ADIALOGS[1]:NWIDTH/2),2,,.T.,,,,,,,,oFldExecuc:ADIALOGS[1],aHeadOk,aColsOk)
...
*******************************************************************************************
/*/
Static Function VisuOkItens(nPos,oFonte)
Local oWizard 	:= NIL
Local oPanSup	:= NIL
Local oPanInf	:= NIL
Local oFolder	:= NIL
